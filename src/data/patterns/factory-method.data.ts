import type { FactoryMethodPatternData, FactoryMethodAnimationState } from '@/shared/types';
...
const codeSteps = [
    ...
    },
    {
        ...
        codeContext: 'Concrete Product (신용카드) 정의',
    },
    {
        stepIndex: 2,
        highlightLines: [58, 59], // FinancialInfo 부분 (Client 내)
        codeContext: 'FinancialInfo 데이터 준비',
    },
    {
        stepIndex: 3,
    ...
    },
    {
        ...
        codeContext: 'Concrete Factory (신용카드) 정의',
    },
    {
        stepIndex: 5,
        highlightLines: [58, 59],
        codeContext: 'Client: 데이터 준바',
    },
    {
        stepIndex: 6,
        highlightLines: [62],
 ...
 * 애니메이션 스텝 정의 (15단계)
 */
const animationSteps: Array<{ stepIndex: number; state: FactoryMethodAnimationState }> = [
    {
        stepIndex: 0,
        state: {
            ...initialState,
    ...
    },
    {
        ...
        state: {
            ...initialState,
            resultMessage: 'Concrete Product: 실제 결제 기능을 구현하는 클래스들입니다.',
        },
    },
    {
        stepIndex: 2,
    ...
    },
    {
        ...
        state: {
            ...initialState,
            resultMessage: 'Abstract Factory: 객체 생성 메서드(createPayment)를 선언합니다.',
        },
    },
    {
        stepIndex: 4,
    ...
    },
    {
        ...
        state: {
            ...
            resultMessage: 'Factory가 내부적으로 new CreditCardPayment()를 호출합니다.',
        },
    },
    {
        stepIndex: 9,
...
export const factoryMethodPatternData: FactoryMethodPatternData = {
    metadata: {
        ...
        nameKo: '팩토리 메서드',
        category: 'creational',
        description: '객체 생성을 서브클래스에 위임하여, 부모 클래스가 구체적인 제품 클래스를 몰라도 객체를 생성할 수 있게 하는 패턴입니다.',
        whenToUse: '생성할 객체의 클래스를 예측할 수 없거나, 객체 생성을 서브클래스에게 위임하고 싶을 때 사용합니다.',
        useCases: [
