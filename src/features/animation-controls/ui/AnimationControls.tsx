 ...
 */
interface AnimationControlsProps<T extends AnimationState = AnimationState> {
 ...
 */
export function AnimationControls<T extends AnimationState = AnimationState>({
  visualizer,
  className,
}: AnimationControlsProps<T>) {
  const {
    isPlaying,
    playSpeed,
    canGoPrev,
